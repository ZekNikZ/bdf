...
# Compute progress
execute as @e[tag=bdf_hotspot,scores={bdf_minions=1}] at @s unless entity @e[tag=bdf_minion,distance=..10] as @a[distance=..5] run scoreboard players add #objective_1 bdf_minions 100
execute as @e[tag=bdf_hotspot,scores={bdf_minions=2}] at @s unless entity @e[tag=bdf_minion,distance=..10] as @a[distance=..5] run scoreboard players add #objective_2 bdf_minions 100
execute as @e[tag=bdf_hotspot,scores={bdf_minions=3}] at @s unless entity @e[tag=bdf_minion,distance=..10] as @a[distance=..5] run scoreboard players add #objective_3 bdf_minions 100
execute as @e[tag=bdf_hotspot,scores={bdf_minions=4}] at @s unless entity @e[tag=bdf_minion,distance=..10] as @a[distance=..5] run scoreboard players add #objective_4 bdf_minions 100
execute as @e[tag=bdf_hotspot,scores={bdf_minions=5}] at @s unless entity @e[tag=bdf_minion,distance=..10] as @a[distance=..5] run scoreboard players add #objective_5 bdf_minions 100
execute as @e[tag=bdf_hotspot,scores={bdf_minions=6}] at @s unless entity @e[tag=bdf_minion,distance=..10] as @a[distance=..5] run scoreboard players add #objective_6 bdf_minions 100
